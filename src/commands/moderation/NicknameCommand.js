...
module.exports = class NicknameCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    ...
    //Executing: 
    await mentionedMember.setNickname(nickName).catch(err => console.log(err) && message.channel.send("Hey I cannot add that nickname due to an error, maximum is 32 characters."));
